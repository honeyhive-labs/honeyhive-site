  ...
  'before-spoil': [
    {
      ...
      stage: '기획',
      title: '아이템 선정과 설계 확정',
      detail: '유통기한 관리 앱 선정 근거와 데이터 모델 문서화, 프로젝트 생성',
    },
    {
    ...
    },
    {
      ...
      stage: '개발',
      title: '인앱결제와 릴리스 서명',
      detail: '정식판 구매와 무료 한도 연결, 배포용 서명 설정',
    },
    {
    ...
    },
    {
      ...
      detail: '식재료 56종 보관 기간 정리와 출처 표기, 아이콘·스크린샷 제작',
    },
    {
      date: '2026-08-08',
      stage: '출시 준비',
    ...
    },
    {
      ...
      detail: '심사 통과와 실기기 설치 확인',
    },
    {
      date: '2026-08-08',
      stage: '테스트',
      title: '1.0.1 — 실기기에서 나온 문제 4건 수정',
      detail: '탭바가 시스템 내비게이션에 가리던 문제 등 에뮬레이터에서 보이지 않던 것들',
    },
    {
      date: '2026-08-09',
      stage: '테스트',
      title: '결제 동작 확인',
      detail: '테스트 카드로 정식판 구매 정상 처리 확인',
    },
    {
      date: '예정',
      stage: '프로덕션',
      title: '프로덕션 출시',
      detail: '신규 개인 계정의 조건은 테스터 12명 확보와 14일 이상 운영',
      status: 'planned',
    },
  ],
};
